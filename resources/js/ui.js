...
function showTradeMood(){
	...
	if(active_selected && active_selected in trade_mood){
		...
		for(e = 0; e < times.length; e++){
			...
			if(up_percentage >= trade_mood_min_percentage_operations && up_percentage_amount >= trade_mood_min_percentage_amount && (up + down) >= trade_mood_min_operations){
				span_data.style.backgroundColor = 'green';
				span_data.style.color = 'white';
			}else if(down_percentage >= trade_mood_min_percentage_operations && down_percentage_amount >= trade_mood_min_percentage_amount && (up + down) >= trade_mood_min_operations){
